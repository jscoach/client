  ...
  return <header
    ...
    <div className="flex items-center justify-between px-4 sm:p-0">
      ...
      <div className="block sm:hidden">
        <button
          onClick={() => toggle(!hide)}
          className="flex items-center px-3 text-gray-700 hover:text-gray-800 active:text-gray-900 outline-none focus:outline-none">
          {hide ?
    ...
    <nav className={classNames({"hidden": hide, "block": !hide}, "px-3 sm:flex")}>
      <a
        ...
        target="_blank"
        className="block px-2 py-1 text-black rounded hover:bg-orange-800">
        Submit a package
      </a>
      <a href="http://blog.js.coach/"
         target="_blank"
         className="mt-1 block px-2 py-1 text-black rounded hover:bg-orange-800 sm:mt-0 sm:ml-2">
        Blog
      </a>
      ...
      <a
        ...
        target="_blank"
        className="mt-1 block px-2 py-1 text-black rounded hover:bg-orange-800 sm:mt-0 mb-4 sm:mb-0 sm:ml-2">
        <svg viewBox="0 0 16 16" width="16" height="16" xmlns="http://www.w3.org/2000/svg" className="inline">
          <path
